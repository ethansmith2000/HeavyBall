...
from .utils import warmup, exp_avg_sq_, beta_debias, update_param_, StatefulOptimizer, mul_, addcdiv_
...
class ForeachLaProp(StatefulOptimizer):
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            mul_(exp_avg_sq, beta1)
            addcdiv_(exp_avg_sq, grad, denom, value=1 - beta1)
            del grad
